...
import 'package:login_logout_app/login_Google/app_bar_title.dart';
...
import 'package:login_logout_app/login_Google/sign_in_screen.dart';
...
class _UserInfoScreenState extends State<UserInfoScreen> {
  ...
  Route _routeToSignInScreen() {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => Index(),
