...
import 'package:login_logout_app/Screens/admin/edit_data.dart';
...
class SData extends StatefulWidget {
  const SData({Key? key}) : super(key: key);
...
class _SDataState extends State<SData> {
  ...
  Future _edit(dynamic foodKey, sendName, sendEName, sendURL) async {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => EditData(
