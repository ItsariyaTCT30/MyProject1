...
class Contagious extends StatefulWidget {
  const Contagious({Key? key}) : super(key: key);

  @override
  _ContagiousState createState() => _ContagiousState();
}

class _ContagiousState extends State<Contagious> {
          ...
          Expanded(
            ...
            child: FirebaseAnimatedList(
              ...
              itemBuilder: (context, snapshot, animation, index) {
                return snapshot.value['type'] == 'โรคติดต่อ'
                    ? Column(children: [
                        InkWell(
                            onTap: () {
                              Navigator.push(
